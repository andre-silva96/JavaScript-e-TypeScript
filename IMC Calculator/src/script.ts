let peso = document.getElementById('text-peso') as HTMLInputElement;
let altura = document.getElementById('text-altura') as HTMLInputElement;
let btn = document.getElementById('button') as HTMLButtonElement;
let res = document.getElementById('text-res') as HTMLElement;
let resImc = document.getElementById('number-imc') as HTMLElement;
